...
-- D[1]	=>  Location: PIN_29,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- D[2]	=>  Location: PIN_135,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- D[3]	=>  Location: PIN_28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A[0]	=>  Location: PIN_33,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A[1]	=>  Location: PIN_26,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF too4Decoder IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \D~0_combout\ = (\A[0]~input_o\) # (\A[1]~input_o\)
...
-- Equation(s):
-- \D~1_combout\ = (\A[0]~input_o\ & !\A[1]~input_o\)
...
-- Equation(s):
-- \D~2_combout\ = (!\A[0]~input_o\ & \A[1]~input_o\)
...
-- Equation(s):
-- \D~3_combout\ = (\A[0]~input_o\ & \A[1]~input_o\)
